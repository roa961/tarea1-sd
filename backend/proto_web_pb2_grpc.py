...
import proto_web_pb2 as proto__web__pb2
...
class SearchStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServerResponse = channel.unary_unary(
                ...
                request_serializer=proto__web__pb2.Message.SerializeToString,
                response_deserializer=proto__web__pb2.SearchResults.FromString,
                )
...
def add_SearchServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetServerResponse': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=proto__web__pb2.Message.FromString,
                    response_serializer=proto__web__pb2.SearchResults.SerializeToString,
            ),
    }
...
class Search(object):
    ...
    def GetServerResponse(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/search.Search/GetServerResponse',
            proto__web__pb2.Message.SerializeToString,
            proto__web__pb2.SearchResults.FromString,
